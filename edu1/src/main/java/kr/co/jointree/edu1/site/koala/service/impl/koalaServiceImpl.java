package kr.co.jointree.edu1.site.koala.service.impl;
...
public class koalaServiceImpl implements koalaService {
    ...
    public static Logger log = LoggerFactory.getLogger(koalaServiceImpl.class);

    @Autowired
    private koalaDAO koalaDAO;
    ...
    public int getSample1Count(Map<String, Object> paramMap){
  		int selectData = koalaDAO.getSample1Count(paramMap);
  		return selectData;
  	}
    ...
    public List<Map<String, Object>> getSample1List(Map<String, Object> paramMap) {
        List<Map<String, Object>> selectData = koalaDAO.getSample1List(paramMap);
        return selectData;
    }
    ...
    public Map<String, Object> getSample1Info(Map<String, Object> paramMap) {
        Map<String, Object> selectData = koalaDAO.getSample1Info(paramMap);
        return selectData;
    }
    ...
    public int setSample1Insert(Map<String, Object> paramMap){
    	...
    	int selectData = koalaDAO.setSample1Insert(paramMap);
    ...
    public int setSample1Update(Map<String, Object> paramMap){
    	...
    	int selectData = koalaDAO.setSample1Update(paramMap);
    ...
    public int setSample1Delete(Map<String, Object> paramMap) {
    	int selectData = koalaDAO.setSample1Delete(paramMap);
        return selectData;
    }
